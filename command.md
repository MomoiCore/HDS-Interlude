...
| `interlude.context` | 白名单用户 | 查看剧本引子、近期逻辑回合卡、近期生活事实桥、当前场景、关系状态和可追溯事实 |
...
- 空闲期生成的剧本引子
- 最近六张逻辑回合卡（主角行动、实际消息、送达状态和未完成事项）
- 最近生活事实桥（昨晚和当天较早发生的时间、地点、行动、人物互动、约定与未完事项）
- 最近可复用的参与者事实及其来源（实际消息、资料、关系或长期事实）
- 活动场景引子与摘要
- 当前剧情弧线
- 当前账号的关系状态
- 主角的演化覆写
